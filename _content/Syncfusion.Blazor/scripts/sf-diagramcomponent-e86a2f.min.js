...
window.sfBlazor.Diagram = function () {
  ...
  var diagram = {
    ...
    invokeDiagramEvents: function invokeDiagramEvents(e, component) {
	  ...
	  console.log("MouseEvents.Invoke"+e.type+"(diagram, canvasBound,",e.type, ",", args.clientX, ",", args.clientY, ",", args.detail, ",", args.offsetX, ",", args.offsetY, ",", args.screenX, ",", args.screenY, ");");
